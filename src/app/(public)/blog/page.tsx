...
export const metadata: Metadata = {
  ...
  description: "Dynamic technical blog and insights by Aditya Kumar. Articles on Next.js, real-time engines, backend engineering, DevOps, and clean code.",
};
...
export default async function BlogPage() {
  ...
  // Fallback to BLOGS sample array from Data.ts if MongoDB has no entries yet
  const blogs: BlogItem[] = dbBlogs.length > 0 ? dbBlogs : BLOGS.map((b) => ({
    _id: b.slug,
    title: b.title,
    slug: b.slug,
    excerpt: b.excerpt,
  ...
  // Dynamically compute topic counts from database blogs
