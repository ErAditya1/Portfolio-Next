...
export const PROJECTS= [
  ...
  title: 'Super Tasky',
  tag: 'Productivity',
  desc: 'Task management web app with project tracking, deadlines, and collaboration tools.',
...
},
  {
    ...
    title: 'BrightVeil',
    tag: 'LMS',
    desc: 'Feature-rich learning platform with video courses, payments and analytics.',
  ...
  },
  {
    ...
    tag: 'Event',
    desc: 'Event booking & management platform with booking flows and dashboards.',
  ...
  },
  {
    ...
    tag: 'College',
    desc: 'College management portal: admissions, attendance, exams and teacher dashboards.',
  ...
  },
  {
    ...
    title: 'MintSlot',
    tag: 'Booking',
    desc: 'Resource booking platform (mentha distillation tank booking) with realtime availability.',
